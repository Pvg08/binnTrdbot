...
public class StrategyRSI2 extends StrategyItem {
    ...
    public StrategyRSI2(StrategiesController controller) {
        super(controller);
        StrategyName = "RSI2";
        config.Add("SMA1-TimeFrame", new StrategyConfigItem("3", "25", "2", "15"));
        config.Add("SMA2-TimeFrame", new StrategyConfigItem("31", "151", "20", "71"));
        config.Add("RSI-TimeFrame", new StrategyConfigItem("2", "12", "2", "4"));
        config.Add("RSI-Threshold", new StrategyConfigItem("1", "25", "1", "20"));
    }
